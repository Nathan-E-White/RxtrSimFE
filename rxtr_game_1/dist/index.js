...
function main() {
    ...
    const homeTabButton = document.getElementById("home-btn");
    const simTabButton = document.getElementById("sim-btn");
    const aboutTabButton = document.getElementById("about-btn");
    // Find the HTML element for the tab divs
    const homeTabDiv = document.getElementById("home-tab");
    const simTabDiv = document.getElementById("sim-tab");
    const aboutTabDiv = document.getElementById("about-tab");
    ...
    const newSimulationButton = document.getElementById("new-sim-btn");
    newSimulationButton.addEventListener("click", newSimulationClickHandler);
    const startSimulationButton = document.getElementById("start-sim-btn");
    startSimulationButton.addEventListener("click", startSimulationClickHandler);
    const stopSimulationButton = document.getElementById("stop-sim-btn");
    stopSimulationButton.addEventListener("click", stopSimulationClickHandler);
    const resetSimulationButton = document.getElementById("reset-sim-btn");
    resetSimulationButton.addEventListener("click", resetSimulationClickHandler);
    const stepSimulationButton = document.getElementById("step-sim-btn");
